...
Future<String> calculateMd5({required List<int> bytes}) =>
    RustLib.instance.api.crateApiSimpleMetadataCalculateMd5(bytes: bytes);

Future<String> generateLargeArtwork({
  required List<int> artworkBytes,
  required String cacheRootPath,
}) => RustLib.instance.api.crateApiSimpleMetadataGenerateLargeArtwork(
  artworkBytes: artworkBytes,
  cacheRootPath: cacheRootPath,
);
