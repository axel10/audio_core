...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  @override
  int get rustContentHash => -710916910;
...
abstract class RustLibApi extends BaseApi {
  ...
  Future<void> crateApiSimpleControllerSeekAudioMs({required PlatformInt64 ms});
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
    ...
    return handler.executeNormal(
      NormalTask(
        callFfi: (port_) {
          ...
          sse_encode_usize(stride, serializer);
          pdeCallFfi(
            generalizedFrbRustBinding,
            serializer,
            funcId: 12,
  ...
  Future<void> crateApiSimpleControllerPauseAudio({
    ...
    return handler.executeNormal(
      NormalTask(
        callFfi: (port_) {
          final serializer = SseSerializer(generalizedFrbRustBinding);
          sse_encode_i_64(fadeMs, serializer);
          pdeCallFfi(
            generalizedFrbRustBinding,
            serializer,
            funcId: 23,
  ...
  TaskConstMeta get kCrateApiSimpleControllerPauseAudioConstMeta =>
      const TaskConstMeta(debugName: "pause_audio", argNames: ["fadeMs"]);
  ...
  TaskConstMeta get kCrateApiSimpleControllerPlayAudioConstMeta =>
      const TaskConstMeta(debugName: "play_audio", argNames: ["fadeMs"]);
  ...
  TaskConstMeta get kCrateApiSimpleControllerSeekAudioMsConstMeta =>
      const TaskConstMeta(debugName: "seek_audio_ms", argNames: ["ms"]);
