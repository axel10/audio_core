...
download_url="https://github.com/axel10/audio_core/releases/download/0.0.1/ffmpeg_lib_linux.tar.gz"
...
# Dynamically adjust prefix path and replace absolute paths with ${prefix} to make them relocatable
