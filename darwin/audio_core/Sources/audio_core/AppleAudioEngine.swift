...
extension AppleAudioEngine {
  ...
  private func signedIntegerScale(bitsPerChannel: Int, fallbackBitsPerChannel: Int) -> Double {
  ...
  private func normalizedSignedIntegerSample(_ value: Int32, bitsPerChannel: Int) -> Double {
  ...
  private func readSignedIntegerSample(
